			   ...
			   <li><a href="home.php"><span class="glyphicon glyphicon-home"></span>&nbsp;Home</a></li>
				...
				<li class="dropdown">
				  ...
				  <ul class="dropdown-menu">
					<li><a href="statpinjam.php"><span class="glyphicon glyphicon-file"></span>&nbsp;Berdasarkan Kategori Peminjam</a></li>
					<li><a href="statrusak.php"><span class="glyphicon glyphicon-file"></span>&nbsp;Berdasarkan Barang Rusak</a></li>
					<li role="separator" class="divider"></li>
					<li><a href="statumum.php"><span class="glyphicon glyphicon-file"></span>&nbsp;Statistik Umum</a></li>
				  </ul>
				</li>				
