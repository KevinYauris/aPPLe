...
<html lang="en">
  ...
  <body>
			   ...
			   <li><a href="?open=home"><span class="glyphicon glyphicon-home"></span>&nbsp;Home</a></li>
				...
				<li class="dropdown">
				  ...
				  <ul class="dropdown-menu">
					<li><a href="?open=home"><span class="glyphicon glyphicon-file"></span>&nbsp;Berdasarkan Kategori Peminjam</a></li>
					<li><a href="?open=home"><span class="glyphicon glyphicon-file"></span>&nbsp;Berdasarkan Barang Rusak</a></li>
	...
	<footer class="footer hidden-print"><div class="container"><p class="text-muted">Lab-Inventroy Management v 1.0</p></div></footer>
