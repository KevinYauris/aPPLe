<?php
	...
	$file="pagecontrol.php?open=peminjaman_addpage";
...
<div class="row">
	...
	<div class="col-sm-7 col-md-8 col-sm-pull-5 col-md-pull-4">
		<a class="btn btn-danger btn-sm" id="btnBack" href="peminjaman.php">Kembali</a>
		<br>
					...
					<table class="table table-striped table-bordered table-condensed table-hover">
						...
						<?php
							...
							while(($rek = arraydb($hsl)) && ($c <= 7)){
								...
								echo "<td align='center'><button class=\"btn btn-success btn-xs btnTambahPeminjaman\" data-val=\"$rek[id_alat]\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Pinjam Alat\"><span class=\"glyphicon glyphicon-list-alt\"></span></button></td>";
								echo "<tr>";
								$c++;
							}
						?>
